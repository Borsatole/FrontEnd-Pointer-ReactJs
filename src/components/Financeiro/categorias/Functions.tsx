...
export function handleDeletar({ Registro, setRelistar }: Deletar) {
  Swal.fire({
    title: `Tem certeza que deseja deletar ${Registro.categoria || "esse produto"}?`,
    ...
    if (result.isConfirmed) {
      ...
      requisicaoDelete(`/Financeiro/Categorias/Delete.php?id=${Registro.id}`)
        .then((response) => {
...
export async function editarProduto({
  ...
  try {
    const response = await requisicaoPut(`/Financeiro/Categorias/Update.php`, data);
...
export function adicionarProduto({ data, registros,
  ...
  requisicaoPost(`/Financeiro/Categorias/Create.php`, data)
