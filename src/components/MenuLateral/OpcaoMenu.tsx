...
export function OpcaoMenuComSubmenu({
  nome,
  svg,
  children,
}: OpcaoMenuComSubmenuProps) {
  ...
  return (
    <div className="mb-1">
      ...
      >
        ...
        <div
          className={` group-hover:text-[var(--sidebarhover-icon)] transition-all duration-200 ${aberto ? "rotate-0" : "rotate-0"}`}
        >
          {aberto ? (
